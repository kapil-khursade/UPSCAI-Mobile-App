import { View, Text, FlatList, TouchableOpacity, ActivityIndicator, TextInput, KeyboardAvoidingView } from 'react-native'
      ...
      <View style={QuestionsStyleSheet.questionCard}>
        ...
        {item.answer_generation_status == "Your Answer Generation Is In Progress" ? 
          <View style={{...QuestionsStyleSheet.statusContainer, ...{backgroundColor: 'orange'}}}>
            <Text style={QuestionsStyleSheet.statusText}>Your Answer Generation In Progress</Text>
          </View>: 
            null
        }
